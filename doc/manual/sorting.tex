...
Sorting these `sub-buffers' may also run into a stage 4 sort when necessary.
This usually implies that performance will be severely affected, hence the
first time this happens during a program a warning will be printed, with the
suggestion to increase the sizes of the sub-buffers.
