...
*/
	...
	#define MINWORKBUFFERTERMS 5
	#define WORKBUFFER 40000000
	#define MINMAXTER 200
	#define MAXTER 40000
	#define MAXBRACKETBUFFERSIZE 3200000
	...
	#define MINMAXTER 200
	#define MAXTER 10000
	#define MAXBRACKETBUFFERSIZE 400000
...
#define MINSCRATCHTERMS      1
#define MAXPATCHES         256
#define MINPATCHES           2
#define MAXFPATCHES        256
#define SORTIOSIZE      200000L

// Defaults 1% the size of 64bit TFORM
#define SSMALLBUFFER   3000000L
#define SSMALLOVERFLOW 4500000L
#define STERMSSMALL      30000L
#define SLARGEBUFFER  15000000L
#define SMAXPATCHES         64
#define SMAXFPATCHES        40
...
#define THREADSCRATCHSIZE 160000L
